const r=`---\r
title: "#1 Vue3와 Vuetify 그리고 Github Pages로 블로그 만들기 - 준비물 및 간략 가이드aaaaaaaaaaaaaaaaaaaaaaaaa"\r
description: Vue3와 Vuetify를 사용해 Github Pages에 블로그를 만드는 과정을 단계별로 정리한 글입니다.\r
tags: [Vue3, Vuetify, Github Pages, 블로그, 웹 개발]\r
author: emdas93\r
category: [개발, 블로그]\r
permalink: /post/2024-08-10-my-first-blog-post\r
slug: 2024-08-10-my-first-blog-post\r
image: ''\r
published: true\r
